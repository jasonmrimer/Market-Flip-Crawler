package com.marketflip.crawler.proton;
/*
 ...
 */
public class MFC_Proton {
	public void startCrawler(String startURLPath) throws Exception {
		...
		(new Thread(new MFC_NetCrawlerManager(bqMFSourceCode, startURLPath))).start();						//delivers sourcecode for analyzing
	}
}
